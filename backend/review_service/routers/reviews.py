...
from shared.models.favorite import Favorite
from shared.models.restaurant import Restaurant, RestaurantPhoto
from shared.models.review import Review, ReviewPhoto
...
# backend/ (routers/ -> review_service/ -> backend/)
BACKEND_ROOT = Path(__file__).resolve().parents[2]
UPLOAD_DIR = BACKEND_ROOT / "uploads" / "review_photos"
...
def delete_review(
    ...
    db.commit()
    _recalculate_rating(db, restaurant_id)
    publish_event(TOPIC_REVIEW_DELETED, event_payload)
