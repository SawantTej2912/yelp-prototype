...
from shared.kafka_topics import TOPIC_RESTAURANT_CREATED, TOPIC_RESTAURANT_UPDATED
from shared.models.restaurant import Restaurant, RestaurantPhoto
from shared.models.user import User
from shared.schemas.restaurant import (
...
# backend/ (routers/ -> restaurant_service/ -> backend/)
...
def delete_restaurant_photo(
    ...
    try:
        disk_path = BACKEND_ROOT / photo.photo_url.lstrip("/")
        if disk_path.exists():
            disk_path.unlink()
    except Exception:
